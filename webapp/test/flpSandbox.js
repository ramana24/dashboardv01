		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#uxdashboardv10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uxdashboardv10-display": {
								"semanticObject": "uxdashboardv10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.dashboardv1.0",
									"url": sap.ui.require.toUrl("ux/dashboardv1/0")
								}
							}
						}
					}
